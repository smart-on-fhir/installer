...
#    ansible.playbook = "provisioning/playbook_patient_picker.yml"
    ...
    ansible.extra_vars = {
      ...
      mock_api_dstu2_server_initial_memory: "64M",
      mock_api_dstu2_server_max_memory: "128M",
      ...
      mock_api_stu3_server_initial_memory: "64M",
      mock_api_stu3_server_max_memory: "128M",
